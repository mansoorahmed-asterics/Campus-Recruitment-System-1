                                ...
                                <ul className="collection with-header myCollections">
                                    ...
                                    {this.props.AllSrequests.length > 0 ? (this.props.AllSrequests.map(v => <li key={v.userId} className="collection-item myCollections">
                                        ...
                                        <button className="btn-small btn-floating transparent secondary-content" >
                                            <i className="material-icons orange-text text-darken-3" onClick={() => { console.log("request cancel") }}>highlight_off</i>
                                        </button>
                                        <span className="secondary-content">&nbsp; &nbsp;</span>
                                        <button className="btn-small btn-floating transparent secondary-content" >
                                            <i className="material-icons orange-text text-darken-3" onClick={() => { console.log("request accept") }}>check_circle_outline</i>
                                        </button>
                                        <span className="secondary-content">&nbsp; &nbsp;</span>
                                        <button className="btn-small btn-floating transparent secondary-content" >
